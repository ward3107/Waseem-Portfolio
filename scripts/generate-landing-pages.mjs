...
//
// Run: node scripts/generate-landing-pages.mjs   (also run by `npm run build`)
...
const cities = [
  ...
  {
    slug: 'web-design-judeide-maker',
    en: 'Judeide-Maker',
    geo: { lat: 32.9195, lng: 35.1889 },
    name: { he: "ג'דיידה-מכר", ar: 'جديدة المكر' },
    he: {
      lead: 'ג\'דיידה-מכר היא מועצה גדולה בגליל המערבי — עם עסקים משפחתיים, אולמות אירועים, בעלי מקצוע ומסעדות שמשרתים את התושבים ואת כל האזור. אני וסים, מכפר יאסיף השכנה, מכיר מקרוב את הדינמיקה המקומית ואת מה שעובד לעסקים בשטח. אני בונה אתרים דו-לשוניים (עברית + ערבית) שנוחים לגלישה מהנייד — כי כך רוב הלקוחות שלכם מחפשים.',
      angle: [
        'שכן מכפר יאסיף — פגישות פנים אל פנים, בלי נסיעה לתל אביב.',
        'אתר בערבית ובעברית מהיום הראשון — לא תרגום מאולתר, אלא בנוי מהיסוד לשני הכיוונים.',
        'כפתור וואטסאפ במקום בולט במקום טופס — כי לקוח בג\'דיידה מעדיף להתקשר.',
      ],
      faq: [
        { q: 'יש לי אולם אירועים בג\'דיידה-מכר — צריך אתר עם גלריה?', a: 'כן. אני בונה אתרי אולמות עם גלריית תמונות ווידאו, מפרט טכני, זמינות בסיסית וכפתור וואטסאפ להזמנה — כדי שהאורח יבדוק זמינות ויסגור מיד.' },
        { q: 'העסק שלי משרת בעיקר לקוחות ערבים — האתר חייב להיות רק בערבית?', a: 'לא, אבל מומלץ שיהיה גם בעברית. הרבה לקוחות פוטנציאליים מהסביבה (עכו, נהריה) מחפשים בעברית — זה מכפיל את מעגל הלקוחות שאתה מגיע אליו.' },
        { q: 'אני יכול לעדכן את האתר לבד אחרי ההשקה?', a: 'כן. אני בונה עם ממשק ניהול פשוט — אתה יכול לשנות טקסטים, תמונות ופרטי פנייה בלי צורך במפתח, גם מהטלפון.' },
      ],
    },
    ar: {
      lead: 'جديدة المكر بلدة كبيرة في الجليل الغربي — فيها أنشطة عائلية، صالات أفراح، أصحاب مهن ومطاعم تخدم السكان وكل المنطقة. أنا وسيم من كفر ياسيف المجاورة، أعرف الديناميكية المحلية عن قرب وما ينجح فعليًا للأنشطة على الأرض. أبني مواقع ثنائية اللغة (عربية + عبرية) مريحة للتصفح من الجوال — لأن هذا كيف يبحث معظم عملائكم.',
      angle: [
        'جار من كفر ياسيف — لقاءات وجهًا لوجه، بدون سفر إلى تل أبيب.',
        'موقع بالعربية والعبرية من اليوم الأول — ليس ترجمة ارتجالية، بل مبني من الأساس للاتجاهين.',
        'زر واتساب في مكان بارز بدلًا من النموذج — لأن العميل في جديدة يفضّل الاتصال.',
      ],
      faq: [
        { q: 'لدي صالة أفراح في جديدة المكر — أحتاج موقع مع معرض صور؟', a: 'نعم. أبني مواقع للصالات مع معرض صور وفيديو، مواصفات فنية، توفّر أساسي وزر واتساب للحجز — بحيث يستطيع الضيف التحقق من التوفّر والحجز فورًا.' },
        { q: 'نشاطي يخدم في الغالب عملاء عربًا — هل يجب أن يكون الموقع بالعربية فقط؟', a: 'لا، لكن يُنصح أن يكون بالعبرية أيضًا. كثير من العملاء المحتملين من المحيط (عكا، نهاريا) يبحثون بالعبرية — هذا يضاعف الدائرة التي تصل إليها.' },
        { q: 'هل يمكنني تحديث الموقع بنفسي بعد الإطلاق؟', a: 'نعم. أبني بواجهة إدارة بسيطة — تستطيع تغيير النصوص والصور وتفاصيل التواصل بدون الحاجة إلى مطوّر، حتى من الهاتف.' },
      ],
    },
  },
  {
    slug: 'web-design-abu-snan',
    en: 'Abu Snan',
    geo: { lat: 32.9484, lng: 35.1770 },
    name: { he: 'אבו סנאן', ar: 'أبو سنان' },
    he: {
      lead: 'אבו סנאן היא כפר דרוזי-נוצרי-מוסלמי מעורב, סמוך לכפר יאסיף — עם רשת עשירה של עסקים משפחתיים, מפעלים קטנים, מסעדות ובעלי מקצוע שמשרתים את הצפון כולו. אני וסים, מהאזור, בונה אתרים אמינים ומהירים שמייצגים כמו שצריך את המורשת של העסק שלכם — ומופיעים בגוגל בדיוק ברגע שלקוח מחפש.',
      angle: [
        'מהאזור, לא מלונדון — פגישות פנים אל פנים בכפר או ברדיוס של רבע שעה.',
        'עיצוב מכובד שמתאים לעסק משפחתי עם היסטוריה — לא סטארטאפי מדי.',
        'SEO מקומי שמכוון גם לחיפושים "בעכו", "בכפר יאסיף" ו-"בגליל המערבי".',
      ],
      faq: [
        { q: 'יש לי מפעל/בית מלאכה באבו סנאן — כדאי לי אתר?', a: 'בהחלט. גם עסקי B2B מקבלים היום פניות דרך גוגל — אתר מקצועי עם דוגמאות עבודה, פרטי מוצרים וטופס פנייה מגדיל את מעגל הלקוחות מעבר לאזור המידי.' },
        { q: 'לא רוצה לשלם אחזקה חודשית — יש פתרון חד-פעמי?', a: 'יש. אני בונה אתרים על תשתית מודרנית (Vercel) — עלות אחסון קרובה לאפס והאתר עובד שנים בלי לגעת בו. תשלום חודשי הוא רק אם רוצים תוספות שוטפות.' },
        { q: 'יש הבדל בין אתר שאני בונה בעצמי בוויקס לאתר מקצועי?', a: 'יש. אתר מקצועי טוען פי 3-5 מהר יותר, מסודר טוב יותר לגוגל, לא נראה כמו תבנית זולה, וכולל SEO מקומי אמיתי. עסק שרוצה לקוחות ולא רק "נוכחות" — ירגיש את ההבדל בפניות.' },
      ],
    },
    ar: {
      lead: 'أبو سنان قرية درزية-مسيحية-مسلمة مختلطة، بجانب كفر ياسيف — فيها شبكة غنية من الأنشطة العائلية والمشاغل الصغيرة والمطاعم وأصحاب المهن الذين يخدمون كل الشمال. أنا وسيم، من المنطقة، أبني مواقع موثوقة وسريعة تمثّل تراث نشاطكم كما يجب — وتظهر في جوجل في اللحظة التي يبحث فيها العميل بالضبط.',
      angle: [
        'من المنطقة، لا من لندن — لقاءات وجهًا لوجه في القرية أو ضمن ربع ساعة سفر.',
        'تصميم محترم يناسب النشاط العائلي مع تاريخ — ليس بأسلوب ستارت-أب مبالغ فيه.',
        'SEO محلي يستهدف عمليات البحث «في عكا»، «في كفر ياسيف» و«في الجليل الغربي».',
      ],
      faq: [
        { q: 'لدي مصنع/مشغل صغير في أبو سنان — هل أحتاج موقع؟', a: 'بالتأكيد. حتى أنشطة B2B تحصل اليوم على استفسارات عبر جوجل — موقع احترافي مع نماذج عمل، تفاصيل المنتجات ونموذج تواصل يوسّع دائرة العملاء إلى ما وراء المنطقة المباشرة.' },
        { q: 'لا أريد دفع صيانة شهرية — هل هناك حل لمرة واحدة؟', a: 'نعم. أبني مواقع على بنية تحتية حديثة (Vercel) — تكلفة الاستضافة قريبة من الصفر والموقع يعمل لسنوات بدون تدخّل. الدفع الشهري فقط إذا أردتم إضافات مستمرة.' },
        { q: 'ما الفرق بين موقع أبنيه بنفسي على Wix وبين موقع احترافي؟', a: 'الفرق كبير. الموقع الاحترافي يُحمّل أسرع بـ 3-5 مرات، منظّم أفضل لجوجل، لا يبدو كقالب رخيص، ويشمل SEO محلي حقيقي. النشاط الذي يريد عملاء وليس مجرد "وجود" — سيشعر بالفرق في الاستفسارات.' },
      ],
    },
  },
  {
    slug: 'web-design-yanuh',
    en: 'Yanuh',
    geo: { lat: 32.9686, lng: 35.2531 },
    name: { he: "ינוח-ג'ת", ar: 'يانوح - جث' },
    he: {
      lead: 'ינוח-ג\'ת היא מועצה דרוזית בגליל העליון, עם עסקים חקלאיים, בעלי מקצוע, אירוח כפרי ומסעדות שמתחילות למשוך תיירים מכל הצפון. עסק בינוח-ג\'ת חייב אתר שמופיע בגוגל כשמישהו מחפש "אירוח כפרי בצפון" או "מסעדת כפר בגליל". אני וסים — בונה אתרים ממוקדי-תיירות שמביאים הזמנות אמיתיות.',
      angle: [
        'מותאם לתיירות כפרית — גלריות, מפה, זמינות והזמנה בכמה קליקים.',
        'SEO ל-"צפון", "גליל עליון" ו-"דרוזי אותנטי" — לא רק לשם הכפר.',
        'מהיר על 3G — כי לקוח שנוסע בכביש 89 חייב שהאתר ייטען מיד.',
      ],
      faq: [
        { q: 'יש לי מסעדה דרוזית בג\'ת — איך אתר יעזור לי להביא תיירים?', a: 'SEO ל-"מסעדה דרוזית בצפון" ו-"אוכל אותנטי בגליל" + הופעה מוצלחת ב-Google Maps + תמונות מקצועיות. שילוב שלושתם מכפיל פי 2-3 את התיירים שנעצרים אצלך במקום להמשיך לדליית אל-כרמל.' },
        { q: 'אני מפעיל צימר קטן — האתר צריך מערכת הזמנות אמיתית?', a: 'לא בהכרח. לצימר עם 1-3 יחידות, טופס פנייה + כפתור וואטסאפ מספיקים. חוסך לך 3-5% על כל הזמנה (עמלות Booking) והלקוח מרגיש קרוב יותר.' },
        { q: 'מה אם אני מוכר תוצרת חקלאית — יש טעם באתר?', a: 'מאוד. אתר עם קטלוג מוצרים + סיפור המשפחה + הזמנה טלפונית מגדיל את ההזמנות מסוחרים בעכו ובנהריה שלא ידעו על קיומך.' },
      ],
    },
    ar: {
      lead: 'يانوح - جث مجلس درزي في الجليل الأعلى، فيه أنشطة زراعية وأصحاب مهن وضيافة ريفية ومطاعم بدأت تجذب السياح من كل الشمال. النشاط في يانوح - جث يحتاج موقعًا يظهر في جوجل عندما يبحث شخص عن «ضيافة ريفية في الشمال» أو «مطعم قروي في الجليل». أنا وسيم — أبني مواقع متخصّصة في السياحة تجلب حجوزات حقيقية.',
      angle: [
        'مناسب للسياحة الريفية — معارض صور، خرائط، توفّر وحجز ببضع نقرات.',
        'SEO لـ«الشمال»، «الجليل الأعلى» و«درزي أصيل» — ليس فقط لاسم القرية.',
        'سريع على 3G — لأن العميل الذي يسافر على الطريق 89 يحتاج أن يُحمَّل الموقع فورًا.',
      ],
      faq: [
        { q: 'لدي مطعم درزي في جث — كيف يساعدني الموقع في جلب السياح؟', a: 'SEO لـ«مطعم درزي في الشمال» و«طعام أصيل في الجليل» + ظهور جيد في Google Maps + صور احترافية. مزج الثلاثة يضاعف السياح الذين يتوقّفون عندك بدلًا من متابعة الطريق إلى دالية الكرمل.' },
        { q: 'أنا أدير شاليه صغير — هل يحتاج الموقع نظام حجز حقيقي؟', a: 'ليس بالضرورة. لشاليه من 1-3 وحدات، نموذج تواصل + زر واتساب كافيان. يوفّر عليك 3-5% على كل حجز (عمولات Booking) والعميل يشعر بقرب أكثر.' },
        { q: 'ماذا لو كنت أبيع منتجات زراعية — هل هناك جدوى من الموقع؟', a: 'كثيرة. موقع مع كتالوج منتجات + قصة العائلة + طلب هاتفي يزيد الطلبات من التجّار في عكا ونهاريا الذين لا يعرفون بوجودك.' },
      ],
    },
  },
];
