export const en: Record<string, string> = {
    ...
    hero_subtitle: "I design and build fast Wix, WordPress, and custom web experiences—combining clear UX with full-stack and AI capabilities.",
    hero_platforms: "Wix · WordPress · WooCommerce · Custom Development",
    ...
    services_title_1: "Websites built ",
    services_title_2: "for the way you work.",
    services_subtitle: "Wix for simple visual management, WordPress and WooCommerce for flexible content and commerce, and custom development when your idea needs more.",
    ...
    service_4_title: "Wix Websites",
    service_4_desc: "Business websites, landing pages, and catalogues with visual editing your team can manage.",
    service_5_title: "WordPress & WooCommerce",
    service_5_desc: "Flexible content sites and online stores with themes, plugins, and a clear handover.",
    ...
    share_field_name_placeholder: "Full name",
    share_field_role: "Role / company (optional)",
    share_field_role_placeholder: "e.g. CEO, Logo Studio",
    share_field_location: "Location (optional)",
    share_field_location_placeholder: "Choose a city",
    share_field_helped: "What did we work on?",
    share_field_helped_multi: "(pick up to 3)",
    share_field_helped_placeholder: "Short project description",
    share_field_recommend: "Would you recommend Waseem?",
    share_recommend_yes: "Definitely yes",
    share_recommend_no: "No",
    share_field_quote: "Your testimonial",
    share_field_quote_placeholder: "Two or three sentences work best.",
    share_ex_hint: "Not sure what to write? Tap an example to start — feel free to edit or send as-is.",
    share_ex_speed_label: "Speed",
    share_ex_speed_text: "Waseem rebuilt our site in under two weeks and it just works — fast, mobile-friendly, and inquiries picked up almost immediately.",
    share_ex_ai_label: "AI chatbot",
    share_ex_ai_text: "The AI chatbot Waseem built now handles about 80% of the questions coming in on WhatsApp. Real answers, in our language, at 2am. Feels like magic.",
    share_ex_clarity_label: "Clear updates",
    share_ex_clarity_text: "What stood out most was how Waseem explained everything without jargon. At every step I knew exactly where the project stood and what came next.",
    share_ex_seo_label: "SEO results",
    share_ex_seo_text: "Within three months of the SEO work, we started showing up on the first page of Google for the searches that matter to us. Direct calls from the site doubled.",
    share_ex_design_label: "Design",
    share_ex_design_text: "The site Waseem built feels genuinely ours — not a template. Clients keep telling us it looks premium, and that's exactly what we needed.",
    share_ex_ontime_label: "On time",
    share_ex_ontime_text: "Waseem delivered on time, hit every milestone we set, and stayed responsive weeks after launch. Rare combination — I'd hire him again without hesitation.",
    share_ex_tech_label: "Tech",
    share_ex_tech_text: "Waseem took a technical problem I thought was messy and made it feel simple. The final build is fast, clean, and easy to extend later.",
    share_ex_partner_label: "Partnership",
    share_ex_partner_text: "Working with Waseem felt more like a partnership than a service. He genuinely cared about the outcome — not just shipping the deliverable.",
    ...
    share_page_intent: "Check out Waseem's Portfolio",
    share_button_aria: "Share this page",
    share_copy_link: "Copy link",
    share_copied: "Copied",
    share_from_waseem_title: "Waseem is asking for a moment",
    share_from_waseem_body: "A short quote from you helps the next business owner decide to work with me.",
    share_star_1: "Poor",
    share_star_2: "OK",
    share_star_3: "Good",
    share_star_4: "Very good",
    share_star_5: "Excellent",
    share_example_toggle: "See what a great testimonial looks like",
    share_example_by: "by",
    share_preview_toggle: "Preview how it will look on the site",
    share_preview_missing: "Fill in your name and testimonial to preview",
    share_reminder_hint: "Prefer to do this later?",
    share_reminder_action: "Ask me to remind you",
    share_reminder_wa_prefill: "Hi Waseem — I want to leave a testimonial but need more time. Please remind me in a few days.",
    a11y_intro_title: "Accessibility options",
    a11y_intro_body: "Tap to open the panel, or continue and the button stays subtle in the corner.",
    a11y_intro_continue: "Continue",
    a11y_intro_dismiss: "Dismiss",
    ...
    page_title_home: "Waseem — Wix, WordPress & Custom Web Developer",
