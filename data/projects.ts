...
export const getLocalizedProjects = (
  ...
  {
    id: 'metaline',
    title: 'Metaline Design',
    category: 'Web',
    description: t('project_6_desc'),
    image: '/assets/metaline.png',
    tech: ['TypeScript', 'React', 'Netlify'],
    link: 'https://anton3.netlify.app/',
    github: 'https://github.com/ward3107/metaline-design',
  },
  {
    id: 'dr-maya',
    title: 'Dr. Maya Khalil',
    category: 'Web',
    description: t('project_7_desc'),
    image: '/assets/dr-maya.png',
    tech: ['TypeScript', 'React', 'Tailwind CSS'],
    github: 'https://github.com/ward3107/dr.website',
  },
  {
    id: 'christmas-sale',
