        ...
        <section className="py-24 bg-slate-50 dark:bg-slate-950 relative overflow-hidden transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-10">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-heading font-bold text-slate-900 dark:text-white mb-4">{t('connectSocials')}</h2>
                    <p className="text-slate-600 dark:text-slate-400">{t('latestUpdates')}</p>
                </div>
                    ...
                    <AnimatePresence>
                        {widgets.facebook && (
                            <motion.div
                                ...
                                whileHover={{ y: -5 }}
                                className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-800 overflow-hidden"
                            >
                                ...
                                <div className="pt-8 px-6 pb-6">
                                    <div className="flex justify-between items-start mb-4">
                                        <div>
                                            <h3 className="font-bold text-lg text-slate-900 dark:text-white">Waseem Dev</h3>
                                            <p className="text-xs text-slate-500 dark:text-slate-400">Full Stack & AI</p>
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4 text-xs text-slate-500 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800 pt-4">
                            ...
                            >
                                <div className="p-6 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <button className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white px-4 py-1.5 rounded-lg text-sm font-bold hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
                                            {t('followMe')}
                                        </button>
                                    </div>
