...
import { Bot, Sparkles, MessageSquare, Calendar, Zap } from 'lucide-react';
...
const AISection: React.FC = () => {
  ...
  return (
    <section id="ai-automation" className="py-24 bg-white overflow-hidden relative">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-1/2">
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-brand-cyan/30 text-brand-cyan text-sm font-bold shadow-lg shadow-brand-cyan/10 mb-8"
            >
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h2 className="text-4xl sm:text-5xl font-heading font-extrabold leading-tight tracking-tight flex flex-wrap gap-x-3 gap-y-1 mb-2 text-slate-900">
            ...
            <motion.p 
              ...
              className="text-slate-600 text-xl mb-10 leading-relaxed max-w-lg"
            >
              {t('ai_desc')}
            </motion.p>
            ...
            >
              <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-200">
                ...
                <div>
                  <h4 className="text-xl font-bold mb-1 text-slate-900">{t('ai_card_1_title')}</h4>
                  <p className="text-slate-500 text-sm">{t('ai_card_1_desc')}</p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-200">
                ...
                <div>
                  <h4 className="text-xl font-bold mb-1 text-slate-900">{t('ai_card_2_title')}</h4>
                  <p className="text-slate-500 text-sm">{t('ai_card_2_desc')}</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:w-1/2 relative">
            <motion.div
              ...
              className="relative z-10 bg-white border border-slate-200 p-8 rounded-2xl shadow-2xl"
            >
               {/* Mock Chat Interface */}
