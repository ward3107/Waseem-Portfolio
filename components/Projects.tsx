      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          ...
          <motion.div
             ...
             className="max-w-2xl"
          >
            <h2 className="text-5xl md:text-7xl font-heading font-black text-slate-900 mb-6 tracking-tight leading-[0.9]">
          ...
          {/* Filter */}
          <div className="flex gap-2 mt-8 md:mt-0 bg-white p-1.5 rounded-xl border border-slate-200 shadow-sm">
            {filters.map((cat) => (
              <button
                key={cat.key}
          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              <div className="relative h-full w-full transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                {/* Front */}
                <div className="absolute inset-0 h-full w-full rounded-3xl bg-white shadow-xl border border-slate-100 overflow-hidden [backface-visibility:hidden]">
                ...
                <div className="absolute inset-0 h-full w-full rounded-3xl bg-slate-900 p-8 text-white [transform:rotateY(180deg)] [backface-visibility:hidden] flex flex-col justify-between shadow-2xl border border-slate-800">
                  ...
                  <div className="flex gap-4 mt-6">
                    ...
                    <a href="#" className="flex-1 flex items-center justify-center gap-2 py-3 bg-white text-slate-900 rounded-xl hover:bg-slate-100 transition-colors font-bold text-sm transform hover:-translate-y-1">
