...
const TechStack: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-slate-950 relative overflow-hidden flex flex-col justify-center border-t border-slate-900 min-h-[600px]">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 text-center mb-12 relative z-20">
         ...
         <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-4xl md:text-5xl font-black text-white text-center mb-8 font-heading uppercase tracking-widest drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]"
         >
         ...
         <div className="flex flex-col items-center justify-center gap-6">
            <motion.div 
              ...
              className="flex flex-wrap justify-center items-center gap-4 md:gap-8 p-4 bg-slate-900/80 border-y border-slate-800 backdrop-blur-md w-full max-w-3xl rounded-xl relative"
            >
                ...
                <div className="flex flex-col items-center min-w-[120px]">
                    ...
                    <span className="text-3xl font-mono font-bold text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]">
                        {score.toLocaleString().padStart(6, '0')}
                    </span>
                </div>

                <div className="flex flex-col items-center min-w-[120px] border-x border-slate-800 px-8">
