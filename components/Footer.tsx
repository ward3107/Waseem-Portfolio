...
const Footer: React.FC = () => {
  ...
  return (
    <footer id="footer" className="bg-slate-950 text-white border-t border-slate-900 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:border-brand-purple hover:bg-brand-purple/10 transition-all duration-300">
                <Github size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:border-brand-blue hover:bg-brand-blue/10 transition-all duration-300">
                <Linkedin size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:border-brand-cyan hover:bg-brand-cyan/10 transition-all duration-300">
                <Twitter size={18} />
              </a>
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-white">{t('footer_links')}</h4>
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-white">{t('footer_services')}</h4>
            <ul className="space-y-4 text-sm text-slate-400">
                {[1, 2, 3, 4, 5].map((i) => (
                    <li key={i}>
          ...
          {/* Newsletter / Contact */}
          <div>
             <h4 className="text-lg font-bold mb-6 text-white">{t('footer_stay_updated')}</h4>
             ...
             <form className="flex flex-col gap-3" onSubmit={(e) => e.preventDefault()}>
                <div className="relative">
                    ...
                    <input 
                        ...
                        className="w-full bg-slate-900 border border-slate-800 rounded-lg pl-10 rtl:pr-10 rtl:pl-4 pr-4 py-3 text-sm focus:outline-none focus:border-brand-purple transition-colors text-white placeholder:text-slate-600"
                    />
                </div>
        ...
        {legalModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-white text-slate-900 w-full max-w-2xl max-h-[80vh] rounded-2xl shadow-2xl overflow-hidden flex flex-col"
            >
              ...
              <div className="p-6 overflow-y-auto leading-relaxed text-slate-600 whitespace-pre-wrap">
              ...
              <div className="p-4 border-t border-slate-100 bg-slate-50 flex justify-end">
                <button 
                  onClick={() => setLegalModal(null)}
                  className="px-6 py-2 bg-slate-900 text-white rounded-lg font-bold hover:bg-brand-purple transition-colors"
                >
                  {t('legal_close')}
                </button>
              </div>
